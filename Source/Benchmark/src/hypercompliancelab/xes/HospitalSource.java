 ...
 *
 */
public class HospitalSource extends LazyInterleavedSource implements Describable
{
	/**
  ...
  protected void populateFromLog(Log log)
  {
	...
	{
		return new FetchAttributeOr("concept:name", "");
	}
	...
	{
		return "A log of medical activities in a Dutch hospital";
	}
}
